...
public class SaisonServiceCrudTest {
    ...
    @Autowired
    private SaisonServiceCRUD serv;
    
    @Before
    public void SaisonServiceCrud() throws DatabaseUnitException, SQLException, ClassNotFoundException, FileNotFoundException {
           // Connexion DB
